...
const options = {
    ...
    base_dir: '.extras/doc/projekthandcd',
    to_dir: 'html',
    mkdirs: true,
};
adoc.convertFile(
    join('.extras', 'doc', 'projekthandcd', 'projekthandcd.adoc'),
    options,
);
...
//     fs.readFileSync(join('extras', 'doc', 'projekthandcd.adoc')),
//     { safe: 'safe', attributes: { linkcss: true }, base_dir: 'doc' },
// );
// const htmlFile = join('extras', 'doc', 'projekthandcd.html');
