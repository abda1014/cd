...
export class CdWriteService {
    ...
    /**
     * Eine Cd wird asynchron anhand seiner ID gelöscht.
     *
     * @param id ID des zu löschenden Cds
     * @returns true, falls die Cd vorhanden war und gelöscht wurde. Sonst false.
     */
    ...
    async #sendmail(cd: Cd) {
        ...
        const titel = cd.titel?.titel ?? 'N/A';
